module LensInfoAnalysis extend self
  ...
  # 除外日本語系
  EX_JP = [
    "改造", "タイプ", "新品", "中古", "ニュー", "オールド", "販売",
    "使捨", "年", "製", "フロント", "付", "眼鏡", "純正", "ミリ",
    "リミテッド", "前後", "型", "軽量", "メガネ", "ジャンク", "説明書", "簡易",
    "オススメ", "世代", "メートル", "表示", "価格", "画像", "撮", "解放", "機", "薦", "勧", "円筒",
    "ケース", "可能", "アダプター", "交換", "表記", "その他", "装"
  ].freeze
  # 除外カメラ系
  EX_JP_LENS = [
    "レンズ", "カメラ", "マウント", "キャップ", "最短", "フィルター", "フード", "ボケ"
  ].freeze
  # 除外英語系
  EX_EN = ["type", "mount", "new", "old", "for", "www", "cap","g\\.a\\.", "\\.\\.\\."].freeze
